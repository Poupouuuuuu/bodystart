      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [
              '[CLA 2400 Eric Favre](/products/cla-2400)',
        ...
        {
          type: 'p',
          text: 'La [L-Carnitine 2000](/products/l-carnitine-2000) est l\'option la plus simple autour de l\'entraînement ; le [CLA 2400](/products/cla-2400) accompagne une période de régime ; les formules complètes type [Lipoxicut](/products/lipoxicut-bruleur-en-poudre) combinent plusieurs ingrédients pour les pratiquants avancés. Tu peux voir tout le rayon [brûleurs de graisse](/categories/bruleurs). Rappel : un produit ne remplace jamais le déficit.',
        },
      ],
    },
    {
